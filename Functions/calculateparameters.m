function [sample,rf,rferr,inf,inferr,funcorr,funcorrerr,minfiberlength,maxfiberlength,positionall,freqall,repall,valuecorrall,eyesall,fibersall,etedall]=calculateparameters(file,globalallexDcut,globalallnum_pieces,globalalllength_pieces,thre1,thre2,thre3,interval,maxlength_bineyes,num_bineyes,limit_lengthfiber)
